<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="门票" prop="menpiao">
          <el-input v-model="ruleForm.menpiao" 
              placeholder="门票" clearable  :readonly="ro.menpiao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="门票" prop="menpiao">
              <el-input v-model="ruleForm.menpiao" 
                placeholder="门票" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服务电话" prop="fuwudianhua">
          <el-input v-model="ruleForm.fuwudianhua" 
              placeholder="服务电话" clearable  :readonly="ro.fuwudianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服务电话" prop="fuwudianhua">
              <el-input v-model="ruleForm.fuwudianhua" 
                placeholder="服务电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否可售" prop="dangdishifouyouyiqing">
          <el-select :disabled="ro.dangdishifouyouyiqing" v-model="ruleForm.dangdishifouyouyiqing" placeholder="请选择是否可售">
            <el-option
                v-for="(item,index) in dangdishifouyouyiqingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否可售" prop="dangdishifouyouyiqing">
	      <el-input v-model="ruleForm.dangdishifouyouyiqing"
                placeholder="是否可售" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	jingdianjieshao : false,
      ...
      ruleForm: {
        ...
        fuwudianhua: '',
        xiangxidizhi: '',
        dangdishifouyouyiqing: '',
        jingdianjieshao: '',
      },
          jingdianfenleiOptions: [],
          dengjiOptions: [],
          dangdishifouyouyiqingOptions: [],
      rules: {
          jingdianbianhao: [
          ],
          jingdianmingcheng: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jingdiantupian = true;
          ...
          if(o=='menpiao'){
            this.ruleForm.menpiao = obj[o];
	    this.ro.menpiao = true;
            continue;
          }
          if(o=='kaifangshijian'){
	    ...
	    this.ro.xiangxidizhi = true;
          ...
          if(o=='dangdishifouyouyiqing'){
            this.ruleForm.dangdishifouyouyiqing = obj[o];
	    this.ro.dangdishifouyouyiqing = true;
            continue;
          }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.dengjiOptions = "AAAAA,AAAA,AAA,AA,A".split(',')
            this.dangdishifouyouyiqingOptions = "是,否".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.jingdianjieshao = this.ruleForm.jingdianjieshao.replace(reg,'../../../honggaitousystem/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
