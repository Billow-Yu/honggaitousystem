<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="座右铭" prop="zuoyouming">
          <el-input v-model="ruleForm.zuoyouming" 
              placeholder="座右铭" clearable  :readonly="ro.zuoyouming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="座右铭" prop="zuoyouming">
              <el-input v-model="ruleForm.zuoyouming" 
                placeholder="座右铭" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否处于疫区" prop="shifouchuyuyiqu">
          <el-select :disabled="ro.shifouchuyuyiqu" v-model="ruleForm.shifouchuyuyiqu" placeholder="请选择是否处于疫区">
            <el-option
                v-for="(item,index) in shifouchuyuyiquOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否处于疫区" prop="shifouchuyuyiqu">
	      <el-input v-model="ruleForm.shifouchuyuyiqu"
                placeholder="是否处于疫区" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="喜好" prop="xihao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="喜好"
                  v-model="ruleForm.xihao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xihao" label="喜好" prop="xihao">
                    <span>{{ruleForm.xihao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="对他的期待" prop="duitadeqidai">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.duitadeqidai" label="对他的期待" prop="duitadeqidai">
                    <span>{{ruleForm.duitadeqidai}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='zuoyouming'){
            this.ruleForm.zuoyouming = obj[o];
	    this.ro.zuoyouming = true;
            continue;
          }
          if(o=='xingzuo'){
	    ...
	    this.ro.diqu = true;
          ...
          if(o=='shifouchuyuyiqu'){
            this.ruleForm.shifouchuyuyiqu = obj[o];
	    this.ro.shifouchuyuyiqu = true;
            continue;
          }
          if(o=='shifougoufang'){
      ...
      this.$http({
		...
		if(json.zuoyouming!=''&&json.zuoyouming){
                this.ruleForm.zuoyouming = json.zuoyouming
	    		this.ro.zuoyouming = true;
		}
        } else {
          this.$message.error(data.msg);
            ...
            this.shifouchuyuyiquOptions = "是,否".split(',')
	...
	this.ruleForm.ziwojieshao = this.ruleForm.ziwojieshao.replace(reg,'../../../honggaitousystem/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `wodeliangyuan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.wodeliangyuanCrossAddOrUpdateFlag = false;
						 this.parent.search();
