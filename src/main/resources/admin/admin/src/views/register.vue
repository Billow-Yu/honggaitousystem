  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   <div class="label">座右铭</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zuoyouming" class="input" type="text" placeholder="座右铭">
			   </div>
			 </div> -->
			<el-form-item label="座右铭" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.zuoyouming" autocomplete="off" placeholder="座右铭"  />
			</el-form-item>
